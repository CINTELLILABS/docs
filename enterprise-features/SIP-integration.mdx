...
To be explicit, this phone number should not be a bland number, but rather the phone number that you want to SIP into. Your SIP "provider" should own this number, and should tell you which one to use (not Bland).
