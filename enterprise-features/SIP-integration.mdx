...
- Bland does **not** accept UDP for SIP messages. 
...
Bland **does not provide** subnets for our Media Stream Servers, as they are not provided as static IPs. Instead, you will receive the IP address of the Media Stream Server in the SDP negotiation.
