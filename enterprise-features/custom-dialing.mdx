...
description: "Create and use custom phone number pools for outbound calls."
---
...
- Specify the `dialing_strategy` parameter with `type: "custom_pooling"` in your outbound call request, providing the associated `pool_id` value. For more details, [see the documentation](/api-v1/post/calls#param-dialing-strategy).

## Cycling your numbers (Optional)

- Update or delete a pool through the custom dialing pool API.
