...
<AccordionGroup>
  ...
  <Accordion title="Step 2: Configure Application">
    ...
    **Controlled access:**
    - Select **Allow everyone in your organization to access** (recommended)
...
<Warning>
**Critical**: Set calendar reminders for certificate and secret expiration!
</Warning>

- **SAML Certificates**: Rotate before expiration (typically 1-3 years)
- **OIDC Secrets**: Rotate every 6-12 months
