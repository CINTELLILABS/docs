...
{/* Cleanup once the rest of the docs describe the new dashboard:
    1. Restore the concept links in this Next steps section:
       Pathways (/tutorials/pathways), Post-call webhooks
       (/tutorials/post-call-webhooks), and Norm (/tutorials/norm).
       They were dropped because they still documented the previous
       dashboard and would have sent readers of this guide back into it.
    2. Remove the `banner` block from docs.json (the site-wide
       transition banner shown during the dashboard rollout).
    3. Remove the "rolled out September 10, 2026" note from the
       opening orientation sentence of this page. */}
