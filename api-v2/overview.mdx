...
Three features build on those: checks gate promotions, experiments run a variant against an environment's pin, and dispositions classify call outcomes. Experiments and dispositions are available only to Enterprise organizations.
