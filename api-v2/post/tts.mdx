...
| `insufficient_credits` | 402 | Your account is out of credits. Add credits and retry. |
...
```json insufficient_credits
{
  "error": {
    "code": "insufficient_credits",
    "message": "Your account is out of credits. Add credits to continue generating speech."
  }
}
```
</ResponseExample>
