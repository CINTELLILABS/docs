...
<ResponseField name="data.version" type="object">
  ...
  <Expandable title="version object">
    ...
    <ResponseField name="snapshot" type="object">
      The full agent configuration (`behavior`, `settings`, `contact`, and `knowledge` when the persona had knowledge base items). Same shape as [Create Agent Version](/api-v2/post/agents-id-versions) accepts. Abbreviated in the example below.
    </ResponseField>
    <ResponseField name="name" type="string">
