...
<ResponseField name="data" type="object">
  ...
  <Expandable title="agent object">
    ...
    <ResponseField name="source_pathway_id" type="string | null">
      ID of the pathway this agent was migrated from. `null` for agents built from scratch, agents migrated from a persona, and agents whose source pathway was deleted.
    </ResponseField>
    <ResponseField name="migrated_at" type="string | null">
      ISO 8601 timestamp of when the agent was created by migrating a pathway or persona. `null` for agents built from scratch.
    </ResponseField>
...
```json Response
{
  "data": {
    ...
    "deleted_at": null,
    "source_pathway_id": "3f0b8c1e-2a47-4d6b-9e51-8c2d7a4f6b10",
    "migrated_at": "2026-09-10T22:59:51.569Z",
    "environments": [
      {
