...
<ResponseField name="data" type="array">
  ...
  <Expandable title="deployment object">
    ...
    <ResponseField name="kind" type="string | null">
      The action that created this deployment: `publish`, `promote`, or `rollback`. `null` for deployments recorded before this field was introduced. Use `kind` instead of comparing `semver` values to tell a promote apart from a rollback.
    </ResponseField>
