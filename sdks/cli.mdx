...
The `bland mcp` command below is a **local** stdio server bundled with the CLI. Reach for it when you specifically want a local process, for example when the CLI is already part of your workflow.
</Note>
