...
This starts a device-authorization flow: the CLI prints a link and a short code, you approve it in your browser, and the CLI stores the resulting API key in your profile. No key to copy and paste. See [Connect your AI agent](/platform/connect-your-agent) for what happens behind that link.
