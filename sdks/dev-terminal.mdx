...
The dev terminal has access to all [MCP tools](/integrations/mcp/tools) plus local pathway operations (read, write, diff, push, pull). Type `/` then Tab to autocomplete commands, or just type naturally.
