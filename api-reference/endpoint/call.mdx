...
<ParamField body="wait_for_greeting" type="boolean" default="false">
  Makes the AI wait for a verbal acknowledgement from the person being called before speaking. Can be used to create a more realistic conversation by waiting for the user to say 'Hey' or similar before speaking.
