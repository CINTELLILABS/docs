...
<ParamField body="dynamic_data[i].method" type="string">
The HTTP method to use for the API call. Allows `"GET"` and `"POST"`.
</ParamField>

<ParamField body="dynamic_data[i].cache" type="boolean">
...
- `context`: How this data should be incorporated into the AI's conversation.
</ParamField>
