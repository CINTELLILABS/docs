...
<ParamField body="base_prompt" type="string" required>
  This is the prompt or task used for all of the phone calls in the request. Information can be inserted into it surrounding variable names with \{\{curly braces\}\}.
