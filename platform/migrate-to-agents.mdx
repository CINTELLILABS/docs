...
description: "The three ways to migrate your existing pathways and personas to an agent."
---

This page introduces the three ways you can migrate your existing pathways and personas to an agent. It goes into detail on managing the migration yourself.
...
The rest of this page covers the **Migrate with your agent** flow. **Option 1** is a single prompt that lets your agent drive the whole setup. **Option 2** is a step-by-step walkthrough for doing the setup yourself, so you understand each piece.
