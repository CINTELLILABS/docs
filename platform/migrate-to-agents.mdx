...
| V1 | V2 | Where |
| --- | --- | --- |
| Call logs, call history, Messages | **Conversations** | **Monitor** |
...
<CardGroup cols={3}>
  ...
  <Card title="Migrate as is" icon="bolt">
    Copies your persona into a new agent exactly as it works today, packaged as a single pathway. Nothing is simulated or changed.
  </Card>
</CardGroup>
