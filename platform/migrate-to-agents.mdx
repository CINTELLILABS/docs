...
Dispositions is available only on Enterprise plans. On other plans it still appears in the agent sidebar, but it is greyed out and can't be opened. Hover over it to see that it's an Enterprise-only feature.
