  ...
  <Tab title="Dashboard">
    <Steps>
      ...
      <Step title="Choose Agent Phone Plan">
        Select the Agent Phone Plan and confirm. Your card is charged \$14.99 for the first month immediately (then \$29.99/month), there's no trial period.
      </Step>
