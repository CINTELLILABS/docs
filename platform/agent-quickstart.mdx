...
Authentication is a separate story. If your agent already has an API key, you are ready. If it does not have one and there is no human around to paste one in, see the [Agent onboarding API](/platform/connect-your-agent) first.
