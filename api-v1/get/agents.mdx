...
<ResponseField name="agents" type="array">
  Each agent object, containing the following fields:
    ...
    - `noise_cancellation` (boolean): Whether background noise suppression is enabled on the caller's audio during web calls.
