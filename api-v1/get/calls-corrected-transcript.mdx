...
Corrected transcripts provides us with a raw output that is generally unusable because we can't neccessarily align the 'assistant' and 'user' roles. To fix this, we provide our version of an 'aligned' transcript. This means essentailly a transcript where the roles are matched to the pieces of text. 
