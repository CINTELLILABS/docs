---
title: "Get Persona"
api: "GET https://api.bland.ai/v1/personas/{persona_id}"
...
<ResponseField name="errors" type="array | null">
  `null` on success. An unknown persona currently returns `404` with `SCHEMA_NOT_FOUND` and the message `Citation schema not found`.
</ResponseField>
