...
<ParamField query="limit" type="number" default="20">
  Number of generations to return. Values are capped at 100.
</ParamField>
...
<ParamField query="voice_id" type="string">
  Filter results to one voice ID, or a comma-separated list of up to 10 voice IDs. Extra IDs are ignored. An empty list such as `voice_id=,` returns no rows.
</ParamField>
