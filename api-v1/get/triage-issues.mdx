...
<ParamField query="search" type="string">
  Free-text search across issue title, description, and ticket number. Ticket numbers match whether you pass the full ID (`T-1023`), the prefix without the dash (`t1023`), or just the number (`1023`).
</ParamField>
