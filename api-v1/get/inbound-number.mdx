...
description: "Retrieve information for an inbound phone number."
---
...
<ResponseField name="voice_id" type="integer">
  The `voice_id` your agent is using - will be a `reduce_latency` voice. 
...
```json Response
{
    ...
    "webhook": "https://webhook.site/0a0a0a0a-0a0a-0a0a-0a0a-0a0a0a0a0a0a",
    "voice_id": 2,
    "dynamic_data": null
}
```
