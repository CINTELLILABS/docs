...
<ResponseField name="call_result_count" type="integer">
  Total number of call results in the run.
</ResponseField>

<ResponseField name="unfinished_call_result_count" type="integer">
  Number of call results in `PENDING`, `QUEUED`, or `RUNNING` status.
</ResponseField>

<ResponseField name="pending_call_result_count" type="integer">
  Number of call results in `PENDING` status.
</ResponseField>

<ResponseField name="queued_call_result_count" type="integer">
  Number of call results in `QUEUED` status.
</ResponseField>

<ResponseField name="running_call_result_count" type="integer">
  Number of call results in `RUNNING` status.
</ResponseField>

<ResponseField name="complete_call_result_count" type="integer">
  Number of call results in `COMPLETE` status.
</ResponseField>

<ResponseField name="failed_call_result_count" type="integer">
  Number of call results in `FAILED` status.
</ResponseField>

<ResponseField name="insufficient_evidence_call_result_count" type="integer">
  Number of call results in `INSUFFICIENT_EVIDENCE` status.
</ResponseField>

<ResponseField name="call_result_status_counts" type="object">
  Counts grouped by call result status.

  <Expandable title="Status count fields">
    <ResponseField name="PENDING" type="integer">
      Number of pending call results.
    </ResponseField>

    <ResponseField name="QUEUED" type="integer">
      Number of queued call results.
    </ResponseField>

    <ResponseField name="RUNNING" type="integer">
      Number of running call results.
    </ResponseField>

    <ResponseField name="COMPLETE" type="integer">
      Number of complete call results.
    </ResponseField>

    <ResponseField name="FAILED" type="integer">
      Number of failed call results.
    </ResponseField>

    <ResponseField name="INSUFFICIENT_EVIDENCE" type="integer">
      Number of call results with insufficient evidence.
    </ResponseField>
  </Expandable>
</ResponseField>
...
```json Response
{
  "data": {
    ...
    "call_result_count": 50,
    "unfinished_call_result_count": 0,
    "pending_call_result_count": 0,
    "queued_call_result_count": 0,
    "running_call_result_count": 0,
    "complete_call_result_count": 48,
    "failed_call_result_count": 1,
    "insufficient_evidence_call_result_count": 1,
    "call_result_status_counts": {
      "PENDING": 0,
      "QUEUED": 0,
      "RUNNING": 0,
      "COMPLETE": 48,
