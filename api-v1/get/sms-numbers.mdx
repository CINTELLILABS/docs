...
<ResponseField name="data[].sms_config.timeout_message" type="string">
  Message sent when the timeout fires, if set.
</ResponseField>

<ResponseField name="data[].sms_config.warning_time" type="number">
  Seconds to wait before sending the warning message, if set. Always less than `time_out`.
</ResponseField>

<ResponseField name="data[].sms_config.warning_message" type="string">
  Message sent at `warning_time`, if set.
</ResponseField>
  ...
  "data": [
    {
      ...
      "sms_config": {
        ...
        "time_out": 15,
        "timeout_message": "This conversation has ended due to inactivity.",
        "warning_time": 10,
