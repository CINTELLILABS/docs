...
<ResponseField name="data.metadata" type="array">
  ...
  - `send_type`: how the attempt was triggered, for example `"spawn"` for the original delivery, or `"resend"` / `"rebuild"` for attempts made through [Resend Post Conversation Webhook](/api-v1/post/sms-conversations-webhooks-resend)
