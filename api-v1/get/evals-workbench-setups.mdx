...
<ParamField query="agent_id" type="string">
  Filter to setups attributed to this voice agent. When set, the response is scoped to that agent; when omitted, setups from every agent (and unattributed setups) are returned.
</ParamField>
