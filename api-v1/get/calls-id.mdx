...
<ResponseField name="persona_id" type="string">
  The unique identifier for the persona used on the call, if the call was sent with a persona. Returns `null` otherwise.
</ResponseField>

<ResponseField name="persona_name" type="string">
  The display name of the persona used on the call. Returns `null` if no persona was used.
</ResponseField>
