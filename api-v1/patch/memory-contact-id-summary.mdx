---
title: "Update Conversation Summary"
api: "PATCH https://api.bland.ai/v1/memory/contact/{memory_id}/summary"
description: "Overwrite the conversation summary for a contact memory. The summary is a plain-text overview of past interactions that the agent uses for context at the start of each conversation."
---
