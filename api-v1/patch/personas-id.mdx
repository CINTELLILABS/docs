...
<ParamField body="call_config" type="object">
  ...
  <Expandable title="call_config">
    ...
    <ParamField body="interruption_threshold" type="number" deprecated>
      Deprecated. Use `resumption_speed` instead.
    </ParamField>
    <ParamField body="resumption_speed" type="number" default={2}>
      Controls how quickly the agent takes the floor after the caller stops talking. `1` fast, `2` medium (default), `3` slow. Supersedes `interruption_threshold`.
    </ParamField>
  </Expandable>
</ParamField>
