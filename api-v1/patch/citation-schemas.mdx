...
<ResponseField name="400 Bad Request">
  Returned when:
  - The `id` query parameter is missing (error code `MISSING_SCHEMA_ID`)
  - None of `name`, `description`, or `schema` is provided in the request body (error code `NO_UPDATES`)
</ResponseField>
...
```json Error Response (No Updates)
{
  "data": null,
  "errors": [
    {
