...
description: "Send an AI phone call with your conversational pathway created [here](https://app.bland.ai/home?page=convo-pathways)"
---
...
<ParamField body="pathway_id" type="string" required>
  ...
  <Accordion title="Conversational Pathway Tutorial">
    ...
    Step by step Tutorial for Pathways.. Coming out today!
