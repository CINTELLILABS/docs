...
description: "Merge two contacts into one. All data from the duplicate contact is moved to the primary contact, and the duplicate is deleted."
---
...
```json Primary Contact Not Found
{
  "data": null,
  "errors": [
    {
...
```json Duplicate Contact Not Found
{
  "data": null,
  "errors": [
    {
      "error": "NOT_FOUND",
      "message": "Duplicate contact not found"
    }
  ]
}
```
