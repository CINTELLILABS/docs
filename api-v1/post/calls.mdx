...
<ParamField body="citation_schema_ids" type="string[]">
  ...
  > <Info>
  >   **Enterprise Feature** - Citation schemas is only available on Enterprise plans. Contact your Bland representative for access.
  > </Info>
</ParamField>
...
<ParamField body="disposition_ids" type="string[]">
  ...
  You can build an outcome here schema [here](https://app.bland.ai/dashboard/analytics?tab=outcomes).

  After building your outcome, you can copy their UUIDs and reference them in your API request for outgoing calls (and you can also attach them to your inbound phone numbers).

  Here's an example:

  ```json
  {
    "disposition_ids": ["7a4ed332-39c4-432e-b909-d2b25f414baf", "1bf37eef-778a-439b-9331-52356fa379e8"]
  }
  ```

  Outcomes specifically use custom JavaScript transformation scripts.

  > <Info>
  >   **Enterprise Feature** - **Outcomes** is only available on Enterprise plans and this is distinct from **Citations**. Contact your Bland representative for access.
  > </Info>
</ParamField>
