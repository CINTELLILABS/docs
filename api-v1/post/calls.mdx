...
<ParamField body="voicemail" type="object">
  ...
  - `action` (enum): What the AI should do when it detects a voicemail. Available options:
  ...
  - `sensitive` (boolean): When `true`, uses LLM-based analysis to detect frequent voicemails.
