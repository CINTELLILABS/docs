...
<ParamField body="calendly" type="object">
  To use Calendly integration you must provide the timezone to get availability/book in and the event url.
  Example usage to use Calendly in calls:
...
<ParamField body="calendly.url" type="string">
  Calendly Link to event that you would share publically.
</ParamField>

<ParamField body="calendly.timezone" type="string">
  Timezone to get and book meetings in. Available timezones are ```America/New_York```, ```America/Chicago```, and ```America/Los_Angeles```.
</ParamField>
