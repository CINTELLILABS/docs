...
<ParamField body="from" type="string">
  ...
  On the [Agent Phone Plan](/platform/agent-phone-plan), calls placed without `from` leave from the plan's own number instead of the pool, so the person you called can call or text it back.
</ParamField>
