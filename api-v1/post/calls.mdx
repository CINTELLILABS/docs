...
<ParamField body="disposition_ids" type="string[]">
 ...
 > Note: This is distinct from **Citations**, which is another Enterprise feature for extracting structured data from transcripts using schemas with variables, groupings, and conditions. Outcomes specifically use custom JavaScript transformation scripts.
</ParamField>
