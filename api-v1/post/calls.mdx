...
<ParamField body="voice" type="string" default="matt">
  ...
  <Accordion title="Moving from `voice_preset_id` to `voice`">
    Voice presets can be directly used with the `voice` parameter. 

    For example, to use the `paola` voice preset, instead of using `voice_preset_id: "caad7545-c58b-4b37-954c-27b93aed8dbd"`, you can use `voice: "caad7545-c58b-4b37-954c-27b93aed8dbd"`.
...
<ParamField body="graph_id" type="string">
  This is the graphID for the pathway you have created on our dev portal. You
  can access the ID of the pathways by clicking the 'Copy ID' button of your
  ...
  "graph_id": "a0f0d4ed-f5f5-4f16-b3f9-22166594d7a7"
  ```
</ParamField>
...
<ParamField body="voice_settings" type="object">
  <Expandable title="properties">
    ...
    <ParamField body="quality" type="integer" default={1}>
      Adjust the quality of the agent's voice. 
      
      - Higher values sound better but may introduce higher latency.
      - Lowering it will make your agent respond faster but can introduce audio artifacts.
    
      Range: `0` to `3`
    </ParamField>

    <ParamField body="stability" type="float" default="0.8">
...
<ParamField body="voice_preset_id" type="string">
  ...
  <Accordion title="Expand to view">
