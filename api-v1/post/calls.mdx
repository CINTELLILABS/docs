...
<Accordion title="View All Error Codes" icon="warning">
  ...
  <ResponseField name="400 - Invalid Phone Number" type="object">
    The destination `phone_number`, `transfer_phone_number`, or a number in `transfer_list` is malformed or fails phone number validation. Provide valid numbers including the country code (for example, `+14155551234`).

    ```json
    {
      "status": "error",
      "message": "Invalid phone number. Please provide a valid phone number including the country code."
    }
    ```
    ...
    {
      "status": "error",
      "message": "Invalid transfer_phone_number. Please provide a valid phone number including the country code."
    }
    ```
    ...
    {
      "status": "error",
      "message": "Invalid transfer_list. Please provide valid phone numbers including the country code."
    }
    ```
  </ResponseField>
