...
<ParamField header="authorization" type="string" required>
  ...
  Get a key from the [dashboard](https://app.bland.ai/dashboard/settings). An autonomous agent with no dashboard session can mint its own with [Connect your AI agent](/platform/connect-your-agent).
</ParamField>
