...
// ex 4
{
  "message": "Handling user speech: Yeah. I'm twenty four. And I'm six foot two.",
  "call_id": "12345678-1234-1234-1234-123456789abc",
  "category": "call",
  "log_level": "info"
}
...
```json dynamic_data
{
  "message": "Storing dynamic data: \n\n vector_data : {\"data\":{\"results\":[{\"id\":\"fedcba98-7654-3210-fedc-ba9876543210\",\"input_text\":\"Yeah bruh sure\",\"similarity\":0.103339002763233,\"chunk_index\":0}]},\"errors\":null}",
  "call_id": "abcdef12-3456-7890-abcd-ef1234567890",
  "category": "call",
  "log_level": "info"
}
