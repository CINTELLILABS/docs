...
<ParamField body="from" type="string">
  ...
  If you have a SIP trunk configured for outbound, you can also pass a SIP trunk identity attached to your trunk — such as a DID or a dial-plan extension like `2001` — as the `from` value. Non-E.164 SIP identities are forwarded to the carrier verbatim, so you don't need to format them as a standard phone number. See [SIP Integration](/enterprise-features/SIP-integration) for how to attach numbers and DIDs to a trunk.
</ParamField>
