  ...
  "call_objects": [
    {
      ...
      "b_cid": "<UUID v7 Compliant ID>" // Provide a UUID v7 Compliant ID for this Call ahead of time. Requires entitlements to use. Contact your Account Executive for more information.
      // /v1/call properties
    },
    {
