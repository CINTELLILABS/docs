---
title: "[BTTS] Beige Text-to-Speech"  
...
Convert text to speech using Bland's proprietary Beige Voices. This endpoint generates high-quality audio from text input with customizable voice parameters and multiple output formats. Supports both streaming and non-streaming responses.

<Note>
This endpoint only supports Bland's Beige Voices. Other voice services are not available through this endpoint.
</Note>
