...
<ParamField body="global" type="object" required>
  ...
  <Expandable title="global object">
    ...
    <ParamField body="agent_message" type="string">
      The initial outbound message to send to each recipient. If omitted, the pathway will handle the opening message.
    </ParamField>
    ...
    <ParamField body="persona_id" type="string">
      Persona ID to use for the batch. Applies to every recipient.
    </ParamField>
    <ParamField body="request_data" type="object">
      Default metadata to associate with each conversation. Per-recipient `request_data` from the CSV is merged on top of this, with recipient values taking precedence.
    </ParamField>
    ...
    <ParamField body="disposition_ids" type="string[]">
      An array of outcome IDs to run when each conversation ends. Overrides any outcomes configured on the SMS number. See [Outcomes](/tutorials/outcomes).
    </ParamField>
    <ParamField body="citation_schema_ids" type="string[]">
      An array of citation schema IDs to extract when each conversation ends. Overrides any citation schemas configured on the SMS number. See [Citations](/enterprise-features/citations).
    </ParamField>
  </Expandable>
</ParamField>
