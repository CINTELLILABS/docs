...
description: "Clone a template to create a new scenario bound to a pathway, persona, or voice agent."
---
...
<ParamField body="pathway_id" type="string">
  The pathway to bind the cloned scenario to. Provide one of `pathway_id`, `persona_id`, or `agent_id`.
</ParamField>

<ParamField body="persona_id" type="string">
  The persona to bind the cloned scenario to.
</ParamField>

<ParamField body="agent_id" type="string">
  The voice agent to bind the cloned scenario to.
</ParamField>
