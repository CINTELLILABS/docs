...
Adds a voice from the public Bland voice library to your org's voice list. Once added, the voice can be used like any other voice you own: passed to [Speak](/api-v2/post/tts), configured via [Update Voice Config](/api-v1/patch/voices-id-config), renamed, and so on.
