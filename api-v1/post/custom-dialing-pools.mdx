...
<ParamField body="phone_numbers" type="array" required>
  Array of phone numbers to include in the pool. Each value must be a valid US (`+1`) or UK (`+44`) number.
...
<ResponseField name="data" type="object">
  The created custom dialing pool object.
...
Once you've created a custom dialing pool, use it in a call request with `dialing_strategy`:
