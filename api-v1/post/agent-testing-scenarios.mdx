...
description: "Create a new test scenario with assertions for a pathway, persona, or voice agent."
---
...
<ParamField body="pathway_id" type="string">
  The pathway to test. Provide exactly one of `pathway_id`, `persona_id`, or `agent_id`.
</ParamField>

<ParamField body="persona_id" type="string">
  The persona to test. Provide exactly one target field.
</ParamField>

<ParamField body="agent_id" type="string">
  The voice agent to test. Provide exactly one target field.
</ParamField>
...
<ParamField body="tags" type="string[]">
  Tags to attach to the scenario.
</ParamField>
...
Returns `201 Created` in the standard envelope.
...
<ResponseField name="agent_id" type="string | null">
  The voice agent ID being tested.
</ResponseField>
...
<ResponseField name="errors" type="null | array">
  `null` on success. A request that does not provide exactly one target returns `400`.
</ResponseField>
