...
<ParamField body="name" type="string" default="Company Knowledge Base">
  KB name (defaults to filename if not provided).
</ParamField>

<ParamField body="description" type="string" default="Company policies, procedures, and frequently asked questions">
