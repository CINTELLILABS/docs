...
Returns `201 Created` with the resource link. If the resource was already attached, the existing link is returned unchanged, still with `201 Created`.
...
<ResponseField name="data" type="object">
  <Expandable title="Resource link fields">
    ...
    <ResponseField name="attached_by_id" type="string | null">
      User ID of the caller that attached the resource. For API key requests this is the user the key belongs to.
    </ResponseField>
