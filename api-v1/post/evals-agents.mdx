...
<ParamField body="agent_id" type="string">
  ID of the voice agent to attribute this eval agent to. Omit this field to create an organization-wide eval agent.
</ParamField>
...
<ResponseField name="data.agent.agent_id" type="string | null">
  ID of the voice agent this eval agent is attributed to, or `null` for an organization-wide eval agent.
</ResponseField>
...
<ResponseField name="data.current_version.judge_config" type="object">
  Public judge configuration. When present, this object contains only `context_sources`, the evidence sources available to the judge. Model and sampling settings are omitted from responses.
</ResponseField>

<ResponseField name="data.current_version.judge_config.context_sources" type="array of strings">
  Evidence sources available to the judge.
</ResponseField>
...
<ResponseField name="data.current_version.levels[].color" type="string | null">
...
```json Response
{
  ...
  "data": {
    "agent": {
      ...
      "agent_id": "7f8e9d0c-b1a2-3456-cdef-789012345678",
      "metadata": {},
    ...
    "current_version": {
      ...
      "judge_config": {
        "context_sources": ["audio_recording", "call_metadata", "transcript"]
      },
      "levels": [
        {
          "level_key": "excellent",
