...
<ParamField header="authorization" type="string" required>
  Your API key for authentication. Organization members need the `owner`, `admin` or `operator` role; other roles receive `403 UNAUTHORIZED`.
</ParamField>
...
```json Insufficient permissions (403)
{
  "data": null,
  "errors": [
    {
