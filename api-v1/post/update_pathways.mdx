  ...
  <Accordion title="Node Data Object Parameters">
      ...
      - `modelOptions`
        ...
        - `interruptionThreshold`
            — How long the AI waits after the caller stops speaking before responding at this node, in milliseconds. Lower values respond sooner; higher values leave more room for the caller to continue.
        - `interruptibility`
