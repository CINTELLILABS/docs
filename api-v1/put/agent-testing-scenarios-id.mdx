...
api: "PUT https://api.bland.ai/v1/agent-testing/scenarios/{id}"
description: "Update an existing test scenario. If assertions are provided, they replace all existing assertions."
---
...
<ParamField body="scenario_type" type="string">
...
<ParamField body="is_required_for_promotion" type="boolean">
...
<ParamField body="tags" type="string[]">
  Replacement tags for the scenario.
</ParamField>
