...
Deleting a knowledge base while a PDF conversion is still in progress cancels the conversion. A deleted knowledge base stays deleted and is never revived by an in-flight conversion.
