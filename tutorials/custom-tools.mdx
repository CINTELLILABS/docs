...
Special Note: If you need to gather detailed letter-by-letter information from the user, set `resumption_speed` to `3` (slow) so the AI waits longer before responding and doesn't interject so quickly.
...
If you have any additional questions, reach out at support@bland.ai and one of our engineers will help.
