...
<img style={{ borderRadius: "0.5rem" }} src="/tutorials/sms/images/sms_dashboard.png" />


Click on any phone number you own, and click 'Setup SMS'.

<img style={{ borderRadius: "0.5rem" }} src="/tutorials/sms/images/phone_num_setup.png" />
...
<img style={{ borderRadius: "0.5rem" }} src="/tutorials/sms/images/sms_chat.png" />
...
<img style={{ borderRadius: "0.5rem" }} src="/tutorials/sms/images/sms_pathway.png" />
...
<img style={{ borderRadius: "0.5rem" }} src="/tutorials/sms/images/inbound_dropdown.png" />
...
<img style={{ borderRadius: "0.5rem" }} src="/tutorials/sms/images/pathway_ui.png" />
...
<img style={{ borderRadius: "0.5rem" }} src="/tutorials/sms/images/sync.png" />


This will open up a modal to allow you to select the pathway you want to merge the changes from.

<img style={{ borderRadius: "0.5rem" }} src="/tutorials/sms/images/merge/compare.png" />
...
<img style={{ borderRadius: "0.5rem" }} src="/tutorials/sms/images/merge/globalprompt.png" />


Nodes

<img style={{ borderRadius: "0.5rem" }} src="/tutorials/sms/images/merge/node.png" />


Pathway Labels


<img style={{ borderRadius: "0.5rem" }} src="/tutorials/sms/images/merge/pathwaylabel.png" />


And finally, you can see the Summary of the changes that will be made.


<img style={{ borderRadius: "0.5rem" }} src="/tutorials/sms/images/merge/summary.png" />
