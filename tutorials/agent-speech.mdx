...
- A caller who speaks at a typical pace, or quickly, gets near-instant responses. Only callers who genuinely hesitate earn extra patience.
...
Only a person's speech counts toward the measurement. While the call interacts with a machine, the agent pauses measurement and responds at its default timing. This covers navigating a phone tree or IVR menu, leaving a voicemail, and waiting for a tone.

When a person answers after a machine interaction, measurement starts fresh with that person. The pacing of a slow greeting or hold prompt never carries into the response timing the person experiences.
