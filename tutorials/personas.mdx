...
- **Noise Cancellation**: Toggle to filter background noise from the caller's audio for cleaner transcription and fewer false interruptions. Recommended for noisy environments like call centers, mobile callers, or households with background activity. Disabled by default.
