...
<img style={{ borderRadius: "0.5rem" }} src="/tutorials/tutorials-assets/webhook.png" />
...
<img style={{ borderRadius: "0.5rem" }} src="/tutorials/tutorials-assets/inbound-number-webhook.png" />
...
<img style={{ borderRadius: "0.5rem" }} src="/tutorials/tutorials-assets/webhook-fires-successfully.png" />
