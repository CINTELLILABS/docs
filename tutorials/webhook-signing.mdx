...
To create a Webhook signing secret, first go to the [Account Settings in the Dev Portal](https://app.bland.ai/dashboard?page=settings) → Settings → General → Webhook Signing Secret.
