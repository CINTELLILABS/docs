...
To create a Webhook signing secret, first go to the [Account Settings in the Dev Portal](https://app.bland.ai/dashboard?page=settings) → Settings → General → Generate Webhook Signing Secret.

Here you can create a new secret by clicking "Generate". It will only be shown once, so save it securely.
