...
The **Prompt** field tells the agent when to use this tool during a call. It's required — you can't save a tool without one.

Be specific about when the tool should fire and when it shouldn't. See [Tool Prompts](/tutorials/tools/overview#tool-prompts) for guidance and examples.
