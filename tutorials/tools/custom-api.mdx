...
You can enable audio for any subset of variables in the same tool — leave transcript-based extraction on for free-form fields (summaries, notes) and turn audio on only for the fields where precision matters.
