...
#### Play the source audio underneath translation

**What it does**: Controls whether each listener hears the other speaker's original voice softly under the translated audio.

**Why it matters**: The underlay preserves tone, emotion, and pacing cues from the original speaker, which helps agents and customers stay in sync. Turning it off delivers clean, translation-only audio on both legs — useful when the underlay feels distracting or when you want the translated voice to be the only thing each party hears.

**Configuration**:
- **Where**: Inside the Live Translation card, visible only after Live Translation is enabled
- **Default**: On (source audio plays ducked under the translation)
- **Off**: Each listener hears translation-only audio with no original-speaker underlay
