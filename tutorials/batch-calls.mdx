...
2. Click **Create Batch** in the top right.
3. Leave the channel switch set to **Phone call**. To send a batch of text messages instead, see [SMS batches](/tutorials/messaging/sms#sms-batches).
