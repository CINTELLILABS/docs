...
- **Configuration**: the widget's name, prompt, allowed domains, message rate limit, webhook URL and webhook mode, and inactivity timeout settings with optional warning and ending messages.
