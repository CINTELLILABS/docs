...
- **V3** (default), single 10-second sample, 17+ languages, highest fidelity. Backed by service `VOX_CPM`.
...
> **Tip**: [Audacity](https://www.audacityteam.org/) is an easy way to edit and trim clips. To pull audio from a YouTube video, [yt-dlp](https://github.com/yt-dlp/yt-dlp) works well.
