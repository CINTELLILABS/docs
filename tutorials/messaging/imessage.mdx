...
<CardGroup cols={2}>
  ...
  <Card title="Superpowers" icon="wand-magic-sparkles" href="/tutorials/messaging/imessage-superpowers">
    Send branded app cards, share location, and update delivered bubbles in place. See [iMessage Superpowers](/tutorials/messaging/imessage-superpowers).
  </Card>
</CardGroup>
...
- [iMessage Superpowers](/tutorials/messaging/imessage-superpowers) (branded app cards, in-place updates, and location sharing)
