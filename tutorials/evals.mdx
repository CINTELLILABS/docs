...
- **Update** publishes changes to an existing judge. If anything runs the judge, a confirmation lists every reference first: test suites, checks required for publishing, and dispositions. The count reads "at least N" when the full list can't be assembled.
