...
You can build and run Evals from the **Evals** section of the [dashboard](https://app.bland.ai), or drive the entire workflow through the Evals API (API reference available on request while Evals is in limited availability).
