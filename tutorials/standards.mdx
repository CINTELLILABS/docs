...
2. Test your prompt (conversation dialogue, variable extraction, or loop condition) against that scenario 
3. Evaluate whether your prompt behaved correctly
