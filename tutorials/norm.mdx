...
<CardGroup cols={2}>
  ...
  <Card title="Claude Code" icon="terminal" href="/integrations/mcp/norm">
    Install the [Bland plugin](/integrations/mcp/norm) to build, test, and ship agents without leaving your terminal.
  </Card>
</CardGroup>

<img style={{ borderRadius: "0.5rem" }} src="/tutorials/tutorials-assets/Norm_dashboard.png" alt="The Norm chat interface in the Bland dashboard" />
...
Norm is billed separately from call usage on a token-based model — every message you exchange with Norm counts toward usage, including questions and clarifications. Cost scales with the complexity of the request and the length of the interaction.

You can view your Norm usage in the dashboard under [Billing & Credits → Plan & Limits](https://app.bland.ai/dashboard/pay). See [Billing](/platform/billing#norm) for full pricing details.
