---
title: "Conversational Pathways New Version"
...
<CardGroup cols={2}>
  <Card icon="message" title="Greater dialogue control">
...
<img
  ...
  src="/tutorials/tutorials-assets/node.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/new_pathway.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/final_pathway.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/pathway_label.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/condition_eg.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/global_node.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/global_eg.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/default_node.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/transfer_node.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/end_node.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/kb_node.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/webhook_node.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/add_global_prompt.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/testing-hero.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/testing-branch.png"
/>
...
<img
  style={{ borderRadius:"0.5rem" }}
  src="/tutorials/tutorials-assets/testing-unit-tests.png"
/>
...
4. **Replacement message** _(optional)_ — Override the original user message with custom text to test how the agent handles different inputs.
5. **LLM grading goal** _(optional)_ — Describe what the agent's response should accomplish. This is used as the evaluation criteria for the test.
...
**Webhook nodes:** Variable extraction runs _before_ the webhook executes, so you can reference extracted variables in the webhook's request data. Variables returned in the webhook's `response_data` are also available in the dialogue generated after the webhook completes.
