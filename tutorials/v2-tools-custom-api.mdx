---
title: "V2 Tools: Custom API Integration"
...
| `data.rest_api_post_status` | number | HTTP status (200, 400, 500, etc.) |
| `data.rest_api_post_status_text` | string | "OK", "Bad Request", "Internal Server Error" |
| `data.rest_api_post_data` | object | The full response body from your API |

The `ok` field is at the response root. The other fields are nested inside `data`.
...
| `data.rest_api_post_status` | equals | `401` | Auth Error Node |
