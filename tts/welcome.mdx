...
<CardGroup cols={2}>
  ...
  <Card title="Speech limits" icon="gauge" href="/tts/limits">
    Instant clones, professional clones, and concurrent generations — and how the one-time $5 top-up unlocks the paid allowance.
  </Card>
</CardGroup>
