...
Select **TTS Studio** in the dashboard sidebar, or go to [app.bland.ai/dashboard/tts](https://app.bland.ai/dashboard/tts). The studio opens inside the dashboard, in your current workspace and theme. Use the tabs across the top to switch between **Studio**, **Voices**, **Creator**, **Developer**, **Usage**, and **Account**.
...
Speech Studio bills against pay-as-you-go TTS credits. See the current per-character rate and refill options on the **Account** tab of TTS Studio, or in [Billing & Plans](/platform/billing).
