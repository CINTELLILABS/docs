...
Very short or unfinished text may remain buffered without producing audio. `end_of_turn` tells Bland to synthesize that remaining tail. The buffering thresholds are tuned internally and are not part of the API contract.
