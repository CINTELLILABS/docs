...
- Toggle detailed execution logs showing secondary actions (webhooks, SMS, scheduling), knowledge base queries, node transitions, and full metadata for each step
