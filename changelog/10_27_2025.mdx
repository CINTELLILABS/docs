...
**API & Development**
- Enhanced [batch API](/api-v2/post/batches) validation to properly recognize `persona_id` as a parameter in the global object, bringing parity with the [/v1/calls](/api-v1/post/calls) endpoint
