...
Attached is a [prompting guide](/tts/voices) that outlines best practices for using these new voices. In most cases, BTTSV2 should behave one to one with existing voices, though some differences may appear depending on usage and prompting.
