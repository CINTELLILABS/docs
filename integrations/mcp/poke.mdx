...
- Optional: a payment card for the [Agent Phone Plan](/platform/agent-phone-plan) (\$2.99 first month, then \$29.99/month, includes a US phone number). Without it, Poke connects on \$2 of free credits, calls from a shared Bland number, and can't text.
