...
description: "Connect Cursor to your Bland account with a one-click install or an mcp.json entry, or install the Bland plugin from the Cursor marketplace."
hidden: true
---
