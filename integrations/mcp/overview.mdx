...
<CardGroup cols={2}>
  ...
  <Card title="Norm plugin" icon="wand-magic-sparkles" href="/integrations/mcp/norm">
    The full Bland development experience in Claude Code: `/norm:*` commands and a file-based pathway workspace.
  </Card>
