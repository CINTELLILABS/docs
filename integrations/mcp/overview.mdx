...
description: "Connect coding agents like Claude Code, Cursor, and Codex, or personal AI agents like Grok Bot, Meta Muse, OpenClaw, Instinct, and Poke, to your Bland account over MCP"
---
...
<CardGroup cols={2}>
  ...
  <Card title="I want my personal AI agent to have a phone" icon="robot" href="/integrations/mcp/personal-agents">
    Grok Bot, Meta Muse, OpenClaw, Instinct, Poke, and any assistant that attaches MCP servers by URL. One dedicated number on the Agent Phone Plan, and the agent can even sign itself up.
  </Card>
</CardGroup>
