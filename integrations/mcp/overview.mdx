...
<CardGroup cols={2}>
  <Card title="Claude Code" icon="terminal" href="/integrations/mcp/claude-code">
    One command, plus the Bland plugin for the full pathway-building workflow.
  </Card>
  <Card title="Bland plugin" icon="wand-magic-sparkles" href="/integrations/mcp/norm">
    The full Bland development experience in Claude Code, Claude Desktop, Cursor, and Codex: skills, `/bland:*` commands, and a file-based pathway workspace.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Connect Claude Code" icon="terminal" href="/integrations/mcp/claude-code">
    The fastest path, including the Bland plugin.
  </Card>
