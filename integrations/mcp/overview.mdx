...
| Category | Highlights |
| --- | --- |
| **Calls** | Place an outbound call (`create_call`), fetch a call's transcript, recording, and summary (`get_call_log`), or hold until a call finishes and get its log back (`wait_for_call`). |
