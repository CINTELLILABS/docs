---
title: "MCP Clients"
description: "Connect the Bland MCP server directly to VS Code, Windsurf, Gemini CLI, or any MCP client, or to Claude Code, Cursor, and Codex without the plugin"
---
