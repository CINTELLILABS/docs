...
Personal AI agents such as Grok Bot, Meta Muse, OpenClaw, Instinct, and Poke act on your behalf. If yours can attach a remote MCP server by URL (Grok Bot, Poke, OpenClaw) or call a REST API with a credential you give it (Meta Muse, Instinct), it can place calls, send texts, and read the results through Bland with no code on your side. Pair it with the [Agent Phone Plan](/platform/agent-phone-plan) and the agent gets a dedicated number of its own.

There are two ways to connect, depending on whether you already have a Bland account. The steps below work for any assistant; for a walkthrough written for one in particular, pick it here:

<Columns cols={4}>
  <Card title="Grok Bot" icon="robot" href="/integrations/mcp/grok-bot" horizontal />
  <Card title="Meta Muse" icon="comment-dots" href="/integrations/mcp/meta-muse" horizontal />
  <Card title="OpenClaw" icon="server" href="/integrations/mcp/openclaw" horizontal />
  <Card title="Instinct" icon="mobile" href="/integrations/mcp/instinct" horizontal />
  <Card title="Poke" icon="message" href="/integrations/mcp/poke" horizontal />
</Columns>
