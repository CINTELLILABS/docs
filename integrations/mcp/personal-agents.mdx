...
- Optional: a payment card for the [Agent Phone Plan](/platform/agent-phone-plan) (\$29.99/month, includes a US phone number). Without it, the agent connects on \$2 of free credits, calls from a shared Bland number or numbers already on your account, and can't text.
