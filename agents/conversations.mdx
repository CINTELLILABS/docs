...
On the server. At **All agents**, a button to the left of the select reads **All agents** until you pick one, then the agent's name. Pick several and it reads the first name and a count.
