...
You can sign up with your Google account or with your phone number. If you choose phone, enter your number and the verification code that's texted to you. Once your developer portal loads, go to the `Send phone call` page.
...
<Steps>
  ...
  <Step title="Write your prompt">
    For the task box either select one of the example prompts or write your own. For more instrucionts about prompting your AI phone agent, read this <a href="https://www.bland.ai/blog/prompting-guide-ai-phone-calls">blog post</a>.
  </Step>
