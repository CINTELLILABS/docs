...
<Note>
**There are two Bland dashboards right now: the new one at `v2.app.bland.ai` and the previous one at `app.bland.ai`.** Most pages here describe the previous dashboard; [Build your first agent](/build-your-first-agent) covers the new one.
</Note>
...
And if you ever need any help along the way, we have a [Discord](https://discord.gg/QvxDz8zcKe) with live support and daily office hours, or you can simply fill out a [support contact form](https://app.bland.ai/dashboard/support) in your account to send your request directly to our team, we're here to solve any and all problems. 
