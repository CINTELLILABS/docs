...
And if you ever need any help along the way, we have a [Discord](https://discord.gg/QvxDz8zcKe) with live support and daily office hours, or you can simply fill out a [support contact form](https://app.bland.ai/dashboard/support) in your account to send your request directly to our team,  either way, we're here to solve any and all problems. 
